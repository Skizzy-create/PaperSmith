    ...
    <div className='bg-[#EFEFEF] w-60 mx-auto h-40 flex flex-col gap-4 p-3 rounded-md '>
        <div  className='flex items-center gap-2 '>
            <div className='bg-pink-400 w-8 h-8 rounded-md mb-1 '>
                <h1 className='text-white font-noto font-medium text-lg text-center'>S</h1>

            </div>
            <div className='flex flex-col relative '>
                <h1 className='font-noto font-medium text-base '>Shashwat Shandilya</h1>
                <h1 className='font-noto font-medium text-[12px] relative -top-1'>Freemium</h1>
            </div>
        </div>
        <UpgradePlan />
        <div className='flex'>
